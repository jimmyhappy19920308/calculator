...
11. 如果點擊等號運算子時如果只有一個數字,則回傳目前的數字,
12. 如果點擊等號運算子時如果只有一個數字與一個運算子,則刪除運算子回傳數字
13. 點擊等號運算子後如果接著點擊新的數字按鈕則清除之前的運算,回傳重新計算後的結果
14. 點擊等號運算子時如果是小數計算,要能回傳正確計算後的結果
15. 點擊清除時會刪除運算式中的最後1位數字或運算子,回傳重新計算後的結果
16. 點擊全部清除時會清除運算式並將計算結果歸 0
